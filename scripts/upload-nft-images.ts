/**
 * DEPRECATED: This script has a bug in the SQL query (missing $ in parameter placeholders)
 * Use upload-nft-images-fixed.ts instead
 * 
 * One-time script to upload NFT category images to IPFS
 * Run with: pnpm --filter @trivia-nft/api upload-images
 */
